...
def main() -> int:
    ...
    print()
    print("Next steps:")
    print("  1. Configure auth in .env — see SETUP.md §1 for the")
    print("     token vs cookie decision (depends on whether your school")
    print("     allows students to self-issue Canvas API tokens).")
    print("  2. cp SECRETS.example.md SECRETS.md")
    print("  3. pip install requests")
    print("  4. Open this folder in Claude Code, say: scan canvas")
    print("     (CC will fill in courses.yaml from probe on first scan.)")
    print()
